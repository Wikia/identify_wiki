...
setup(
    ...
    install_requires=['nlp_services>=0.0.2', 'requests', 'nltk', 'beautifulsoup4'],
    dependency_links=['https://github.com/tristaneuan/nlp_services/archive/master.zip#egg=nlp_services-0.0.2']
    )
